  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Más de 15 años impulsando equipos comerciales a crecer, liderar y conectar desde la emoción y el propósito."
        />

        {/* Meta para redes sociales */}
        <meta property="og:title" content="Luca Chiesa | Ventas con propósito y liderazgo consciente" />
        <meta
          property="og:description"
          content="Liderar y vender desde lo que realmente conecta."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://lucachiesa.net" />
        <meta property="og:image" content="https://lucachiesa.net/brand/og-preview.jpg" />

        {/* Twitter meta (también usado por LinkedIn) */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Luca Chiesa | Ventas con propósito y liderazgo consciente" />
        <meta
          name="twitter:description"
          content="Liderar y vender desde lo que realmente conecta."
        />
        <meta name="twitter:image" content="https://lucachiesa.net/brand/og-preview.jpg" />

        {/* Favicon y color del tema */}
