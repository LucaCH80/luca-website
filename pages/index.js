...
export default function HomeES() {
  // Paleta
  const bg = "#F4F7FB";      // fondo suave profesional
  const ink = "#111";        // texto principal
  const mute = "#444";       // texto secundario
    ...
    <>
      ...
      <div
        style={{
          ...
          backgroundColor: bg,
          color: ink,
          // Nueva escala de espacios (más aire y equilibrio)
          padding: "96px 20px 64px",
          position: "relative",
        }}
      >
        {/* Header con selector de idioma (píldoras) */}
        <header
          style={{
            position: "absolute",
            top: "18px",
        ...
        {/* Bloque hero con jerarquía tipográfica refinada */}
        <h1
          style={{
        ...
        {/* CTA con microinteracciones suaves */}
        <a
          ...
          onMouseOver={(e) => {
            ...
            e.currentTarget.style.boxShadow = "0 12px 28px rgba(47,103,178,0.28)";
          }}
          onMouseOut={(e) => {
            e.currentTarget.style.transform = "none";
            e.currentTarget.style.backgroundColor = accent;
            e.currentTarget.style.boxShadow = "0 8px 20px rgba(47,103,178,0.20)";
          }}
        >
          Contacta con Luca
        </a>
